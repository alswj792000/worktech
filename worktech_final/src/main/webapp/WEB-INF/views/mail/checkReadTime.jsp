			...
			<section class="section">
				<div class="section-header">
					...
					<div class="section-header-breadcrumb">
		            	...
		            	<div class="breadcrumb-item">수신 확인</div>
					</div>
				</div>
			</section>
												...
												<tr>
													<td>
														<div class="icheck-primary">
															<input type="checkbox" value="${mi.mailNo }"
																name="check" id="check${idCount.count }"> <label
													...
													<td>
														<c:if test="${mi.receiverRTime != null }">
															...
															<fmt:formatDate pattern="yyyy-MM-dd HH:mm"
																value="${mi.receiverRTime }" />
														</c:if>
														<c:if test="${mi.receiverRTime == null }">
															<span class="mailSR-info"> 읽지않음 </span>
														</c:if>
													</td>
														...
														<c:if test="${ fmtNumber <= 0}">
															<td class="mailbox-date"><span class="mailSR-info">
																	<fmt:formatDate value="${d }"
																		var="currentMinutues" pattern="HHmm" />
																	<fmt:formatDate value="${mi.sDate }"
																		pattern="HHmm" var="compMinutes" />
